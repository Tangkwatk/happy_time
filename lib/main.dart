  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        packagePage.routeName: (context) => const packagePage(),
        giftPage.routeName : (context) => const giftPage(),
        packageDetailPage.routeName: (context) => const packageDetailPage(),
        giftDetailPage.routeName: (context) => const giftDetailPage(),
